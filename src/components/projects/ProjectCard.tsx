/**
 * ProjectCard — Individual project card wrapped in 21st.dev / React Bits GlowCard
 * with dynamic cursor tracking, vivid glowing borders, category gradient, tech stack tags,
 * and live/github links.
 */
...
export default function ProjectCard({ project: p, index }: Props) {
    ...
    return (
        ...
        >
            ...
            >
                {/* Inner content wrapper with rounded corners */}
                <div className="w-full h-full flex flex-col rounded-2xl overflow-hidden bg-[#0c0c0f]/85 backdrop-blur-md">
                    {/* ── Header / Image area ── */}
                    <div
                    ...
                    >
                        ...
                        {/* Year badge */}
                        <div
                            className="absolute top-4 right-4 font-mono text-[10px] tracking-[0.2em] px-3 py-1.5 rounded-sm border z-10"
                            style={{
                        ...
                        {/* Category badge */}
                        <div
                            className="absolute top-4 left-4 font-mono text-[9px] tracking-[0.15em] uppercase px-2.5 py-1 rounded-sm z-10"
                            style={{
                                color: `${p.color}cc`,
                    ...
                    <div className="flex flex-col flex-1 p-6 md:p-7 relative z-10">
                        {/* Title */}
                        <h3
                            className="text-display text-[#f0f0f0] whitespace-pre-line hover:text-white transition-colors"
